...
class SuggestPrompt extends Base {
  ...
  onTabKey() {
    this.suggestionIndex =
      this.suggestionIndex < this.getSuggestions().length - 1
  ...
  makeSuggestion() {
    this.rl.clearLine();
    this.rl.write(this.getSuggestions()[this.suggestionIndex]);
  }
  ...
  getSuggestions() {
    return this.opt.suggestions instanceof Function ? this.opt.suggestions(this.answers) : this.opt.suggestions;
  }
}
